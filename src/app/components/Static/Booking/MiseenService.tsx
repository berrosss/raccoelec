...
const Raccordement = () => {
  ...
  const validationSchemaForm2 = () => yup.object().shape({
    typesite: yup.string().required("Veuillez choisir le type de site souhaité."),
    autreType: yup.string().when('typesite', {
    is: 'Autre',
  ...
  const validationSchemaForm3 = yup.object().shape({
    ...
    referencebranchement: yup.array()
    .of(
      yup.string()
        .length(1, 'Chaque entrée doit contenir exactement 1 caractère.')
        .required('Ce champ est obligatoire.')
    )
    .min(12, 'Les 12 entrées sont obligatoires.')
    .max(12, 'Vous ne pouvez saisir que 12 entrées.'),
  });
              ...
              <form onSubmit={methods.handleSubmit(onSubmit)} className="w-full p-[40px] rounded" style={{ boxShadow: "0 10px 30px 0 rgba(62, 87, 111, 0.2)" }}>
                      ...
                      <div>
                        <div className="mb-[60px]">
                          ...
                          <div className="flex justify-start items-start flex-col md:flex-row w-full gap-2 text-center">
                            {['Déclarer mes panneaux solaire', 'Souscrire contrat EDF / ENGIE', 'Modification de puissance'].map((option, index) => (
                  ...
                  {currentStep === 2 && (
                    <div>
                        ...
                        <div className="max-w-[600px] mx-auto">
                          ...
                          <div>
                            {methods.formState.errors.typesite && <p className="text-red-500 text-sm">{methods.formState.errors.typesite.message}</p>}
                          </div>
                  ...
                  {currentStep === 3 && (
                    <div>
                        ...
                        <div className="p-6 bg-white rounded-lg shadow-md w-full mb-10 flex justify-center items-center flex-col mt-10">
                          <div className="mb-4">
                          ...
                          <div className="grid grid-cols-4 gap-2 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-12">
                            {Array.from({ length: 12 }).map((_, index) => (
                              <input
                                key={index}
                                {...methods.register(`referencebranchement.${index}`)}
                                type="text"
                                maxLength={1}
                        ...
                        <div>
                            {Array.isArray(methods.formState.errors.referencebranchement) &&
                              methods.formState.errors.referencebranchement.map((error, index) => (
                      ...
                      <div className="mb-10">
                        ...
                        <ul className="mb-8">
                          ...
                          <MdOutlineHomeWork className="size-8 inline-block text-slate-500" />
                            ...
                            <strong>{formData.typesite}</strong>
                          </li>
